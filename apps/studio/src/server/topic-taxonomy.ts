...
const CATEGORY_RULES: Array<[StudioTopicCategory, RegExp]> = [
  ["society", /台风|暴雨|地震|救灾|事故|伤亡|去世|逝世|病逝|死亡|身亡|遇难|失联|警方|民警|法院|获刑|索赔|不担责|枪杀|威胁|轰炸|公共安全|社会|空袭|战争|冲突|外交|制裁|绑架|遭绑|辱骂|诈骗|维权|食物中毒|国际关系|中东局势|民族情绪|扫黄|涉黄|沉没|落水|冲入|伊朗|以色列|叙利亚|政府党组|政府任职|政协|援.*装备.*牵制|对外军援/],
