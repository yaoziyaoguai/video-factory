...
export const VOICE_PRESETS = [
  ...
  { id: "documentary", label: "人物纪实", description: "留出情绪和画面呼吸", preferredProfileIds: ["macos:Meijia", "macos:Sinji", "minimax:female-chengshu"], rate: 170, pauseScale: 1.2, masteringPreset: "intimate" },
  ...
  { id: "lifestyle", label: "生活清单", description: "自然亲近，节奏不过满", preferredProfileIds: ["macos:Meijia", "macos:Sinji", "minimax:male-qn-qingse", "minimax:female-tianmei"], rate: 185, pauseScale: 1, masteringPreset: "natural" },
...
export function applyTemplateVoiceRecommendation(
  ...
  return {
    profileId: preset.preferredProfileIds[0] ?? current.profileId,
    rate: preset.rate,
